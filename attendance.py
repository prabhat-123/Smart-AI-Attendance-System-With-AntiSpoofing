...
embedding_obj = Extract_Embeddings(model_path = 'facenet_keras.h5')
...
graph_path = "deploy.prototxt.txt"
weights_path = "res10_300x300_ssd_iter_140000.caffemodel"
base_path = os.getcwd()
net = cv2.dnn.readNetFromCaffe(os.path.join(base_path,graph_path),os.path.join(base_path,weights_path))
# ####################### Admin Login page #############
...
###################### To delete the items
    ...
    def add_photo():
        ...
        if (Id == "" or name == ""):
            ...
            graph_path = "deploy.prototxt.txt"
            weights_path = "res10_300x300_ssd_iter_140000.caffemodel"
            net = cv2.dnn.readNetFromCaffe(graph_path,weights_path)
...
B8 = Button(attendance, text = "Embeddings", fg = "green", font = ("Times new Roman", 15), image = photo8, height = 230, width = 265,command= face_embedding, compound = BOTTOM)
